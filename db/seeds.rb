# la = Gym.create(name: "L.A. Fitness", adress: "Suite 981 1795 Leida Fords, Nataliemouth, TN 14377-4979")
# planet = Gym.create(name: "Planet Fitness", adress: "7768 David Avenue, Greenside, PA 67475-3655")
...
steve = Client.create(name: "Steve Stevenson", age: 30)
